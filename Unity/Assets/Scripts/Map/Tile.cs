...
public class Tile : MonoBehaviour
{
    ...
    private static UiHack userInterface;
    ...
    public void SetUpTile(TileFlag flags)
    {
        ...
        if (userInterface == null) {
            GameObject gameUI = GameObject.Find("TempUIHandler");
            userInterface = gameUI.GetComponent<UiHack>();
        }
    }
    ...
    void OnMouseDown()
    {
        ...
        try
        {
            userInterface.DisplayBuildings(this);
        }
        catch (Exception e)
        {
            Debug.Log(e);
