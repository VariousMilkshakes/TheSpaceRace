	...
	class Quarry : Building
	{
		public Quarry(Player builder) : base (typeof(Quarry), builder)
		{
			...
			try
			{
				...
				string spritePath = buildingConfigs.LookForProperty("Quarry", "Sprite.All").Value;
			...
			Input = new SpaceRace.PlayerTools.ResourceBox(SpaceRace.PlayerTools.Resources.Population, 0, 1);
			Output = new SpaceRace.PlayerTools.ResourceBox(SpaceRace.PlayerTools.Resources.Stone, 0, 10);
		}

		public override SpaceRace.PlayerTools.ResourceBox BuildRequirements()
		{
			return new SpaceRace.PlayerTools.ResourceBox(SpaceRace.PlayerTools.Resources.Wood, 30);
		}
